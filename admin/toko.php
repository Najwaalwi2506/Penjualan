...
// List toko (penjual) + data penjual
$query = "
    SELECT t.*, u.nama as penjual, u.email, u.alamat, u.no_telp, u.angkatan
    FROM toko t
    JOIN users u ON t.user_id = u.id
    ORDER BY t.created_at DESC
";
$toko = mysqli_query($koneksi, $query);
if ($toko === false) {
...
<div class="wrapper">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="toko.php" class="active"><span class="material-symbols-outlined icon">store</span> Kelola Toko</a></li>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($toko)) { ?>
                            <tr>
                                ...
                                <td><?php echo (int)($row['total_terjual'] ?? 0); ?> produk</td>
